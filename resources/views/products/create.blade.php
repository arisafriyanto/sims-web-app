                        ...
                        <div class="col-md-8">
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" id="name" class="form-control form-control-lg"
                                    value="{{ old('name') }}" placeholder="Masukan nama barang">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" name="purchase_price" id="purchase_price"
                                    class="form-control form-control-lg" value="{{ old('purchase_price') }}">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" name="stock" id="stock" class="form-control form-control-lg"
                                    value="{{ old('stock') }}" placeholder="Masukan jumlah stok barang">
